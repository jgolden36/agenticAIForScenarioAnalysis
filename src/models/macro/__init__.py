...
Adapters for NEMS, NREL, MPSGE.jl, OpenCGE, pycge, and MIRAGRODEP. These models
translate commodity-level price shocks and supply disruptions into economy-wide
impacts: GDP, inflation, employment, trade balances, and long-run structural
adjustments. They operate at either the short-run macro or long-run
